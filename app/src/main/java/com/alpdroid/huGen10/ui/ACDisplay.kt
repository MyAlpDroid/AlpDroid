        ...
        if (application.isBound)
        {
            timerTask = {
                activity?.runOnUiThread {
                   ...
                   speed.text = String.format(" %d KM/H", (alpineServices.get_Disp_Speed_MM()/100).toInt())
                    ...
                    when (alpineServices.get_CurrentGear()) {
                        0 -> StringGenerated = "d1"
                        1 -> StringGenerated = "d2"
                        2 -> StringGenerated = "d3"
                        3 -> StringGenerated = "d4"
                        4 -> StringGenerated = "d5"
                        5 -> StringGenerated = "d6"
                        6 -> StringGenerated = "d7"
                        else -> {
                            StringGenerated = "unknown"
                        }
                    }
