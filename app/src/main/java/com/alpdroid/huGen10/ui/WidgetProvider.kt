...
import com.alpdroid.huGen10.WidgetService
...
class WidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            val rv = RemoteViews(context.packageName, R.layout.widget_screen)
           ...
           // widget_list is part of widget_layout
            ...
            val toastIntent = Intent(context, WidgetProvider::class.java)
