...
class VehicleServices : LocationListener {
    ...
    */
    ...
    private fun getFrameParamsFromBus(bus:Int,canID: Int, bytesNum: Int, len: Int): Int {
        ...
        try {
            frame = application.alpineCanFrame.getFrameFromBus(bus, canID)!!
        } catch (e: Exception) {
            return 0
        }
    ...
    @Synchronized
    fun setFrameParams(bus:Int,candID: Int, bytesNum: Int, len: Int, param: Int) {

        var frame: CanFrame

        application.alpineCanFrame.getFrameFromBus(bus,candID).also {
            if (it != null) {
    ...
    fun getFrameBool(bus:Int,candID: Int, bytesNum: Int): Boolean {
    ...
    //2F01090301
    suspend fun ask_OBDFuelTemperature()
    {
        pushOBDParams(CanECUAddrs.CANECUSEND_0.idcan,0x0109, 0x2F, byteArrayOf(0x03,0x01))

    }

    fun get_OBDFuelTemperature():Int = this.getOBDParams(0x0109, 0x6F, CanECUAddrs.CANECUREC_0.idcan, 8, 8) - 50

    fun get_OBDFuelPumpDuty():Int = this.getOBDParams(0x117F, 0x62, CanECUAddrs.CANECUREC_0.idcan, 0, 8)

    suspend fun ask_OBDFuelPumpDuty()
    {
        pushOBDParams(CanECUAddrs.CANECUSEND_0.idcan,0x117F, 0x22, ByteArray(0))

    }

    suspend fun ask_OBDRadiatorFan()
    {
        pushOBDParams(CanECUAddrs.CANECUSEND_0.idcan,0x1178, 0x22, ByteArray(0))

    }

    fun get_OBDRadiatorFan():Int = this.getOBDParams(0x1178, 0x62, CanECUAddrs.CANECUREC_0.idcan, 0, 8) - 50
    ...
    fun get_GearboxOilTemperature(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.AT_CANHS_R_01.idcan, 0, 8)

    /** Get Code DifferentialTorqueCalculated **/
    fun get_DifferentialTorqueCalculated(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.AT_CANHS_R_01.idcan, 8, 16)
    ...
    fun get_ACCompPowerUsed_V2(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 0, 8)

    /** Get Code ACCompClutchStatus **/
    fun get_ACCompClutchStatus(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 8, 1) != 0

    /** Get Code BlowerState **/
    fun get_BlowerState(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 9, 1) != 0

    /** Get Code ACCoolingFanSpeedRequest **/
    fun get_ACCoolingFanSpeedRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 10, 2)

    /** Get Code PumpActivationRequest **/
    fun get_PumpActivationRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 12, 2)

    /** Get Code AC_StopAutoForbidden **/
    fun get_AC_StopAutoForbidden(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 14, 2)

    /** Get Code PTCNumberThermalRequest **/
    fun get_PTCNumberThermalRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 16, 4)

    /** Get Code ACMinEngineIdleSpeedRequest **/
    fun get_ACMinEngineIdleSpeedRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 20, 4)

    /** Get Code MinimumVoltagebyAC **/
    fun get_MinimumVoltagebyAC(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 24, 4)

    /** Get Code ACCompRequest **/
    fun get_ACCompRequest(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 28, 1) != 0

    /** Get Code ACCompClutchRequest **/
    fun get_ACCompClutchRequest(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 29, 1) != 0

    /** Get Code RearDefrostRequest **/
    fun get_RearDefrostRequest(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 30, 1) != 0

    /** Get Code ChillerActivationStatus **/
    fun get_ChillerActivationStatus(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 32, 2)

    /** Get Code BatTempoDelayRequest_CLIM **/
    fun get_BatTempoDelayRequest_CLIM(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 34, 2)

    /** Get Code FrontDefrostRequest **/
    fun get_FrontDefrostRequest(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 36, 1) != 0

    /** Get Code AC_SailingIdleForbidden **/
    fun get_AC_SailingIdleForbidden(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 37, 2)

    /** Get Code InternalTemp **/
    // TORQUE_ECM_CANHS_RNr_01
    fun get_InternalTemp(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.CLIM_CANHS_R_03.idcan, 40, 16)
    ...
    fun get_MILDisplayState(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 0, 4)

    /** Get Code DisplayedOilLevel **/
    fun get_DisplayedOilLevel(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 4, 4)

    /** Get code GlobalVehicleWarningState **/
    fun get_GlobalVehicleWarningState(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 8, 2)


    /** Get Code WasherLevelWarningState **/
    fun get_WasherLevelWarningState(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 10, 1) != 0

    /** Get Code BatteryWarningState **/
    fun get_BatteryWarningState(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 11, 2)

    /** Get Code ParticulateFilterWarningState **/
    fun get_ParticulateFilterWarningState(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 13, 1) != 0

    /** Get Code FuelAutonomyInKm **/
    fun get_FuelAutonomyInKm(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 14, 10)

    /** Get Code FuelLevelDisplayed **/
    fun get_FuelLevelDisplayed(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 24, 7)

    /** Get Code WaterInDieselWarningState **/
    fun get_WaterInDieselWarningState(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 31, 1) != 0

    /** Get Code FixedMaintenanceRange **/
    fun get_FixedMaintenanceRange(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 32, 8)

    /** Get Code AverageFuelConsumptionAfterSale **/
    fun get_AverageFuelConsumptionAfterSale(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 40, 8)

    /** Get Code MalfunctionLampWarningState **/
    fun get_MalfunctionLampWarningState(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 48, 2)


    /** Get Code BadgeWarningState **/
    fun get_BadgeWarningState(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 50, 1) != 0

    /** Get Code PersoOilDrainingRange **/
    fun get_PersoOilDrainingRange(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_01.idcan, 56, 8)
    ...
    fun get_EngineFanSpeedRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 0, 2)


    /** Get Code EmissionN_IdleRequest **/
    fun get_EmissionN_IdleRequest(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 2, 1) != 0

    /** Get code MaxElectricalPowerAllowed **/
    fun get_MaxElectricalPowerAllowed(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 3, 5)

    /** Get Code ElectricalPowerCutFreeze **/
    fun get_ElectricalPowerCutFreeze(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 8, 2)

    /** Get Code EngineStatus_R **/
    fun get_EngineStatus_R(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 10, 2)

    /** Get Code EngineStopRequestOrigine **/
    fun get_EngineStopRequestOrigine(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 12, 4)

    /** Get Code CrankingAuthorization_ECM **/
    fun get_CrankingAuthorization_ECM(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 16, 2)

    /** Get Code ACCompClutchActivation **/
    fun get_ACCompClutchActivation(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 18, 1) != 0

    /** Get Code OpenActiveBrakeSwitch_ECM **/
    fun get_OpenActiveBrakeSwitch_ECM(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 19, 2)


    /** Get Code N_IdleInstructionSignal **/
    fun get_N_IdleInstructionSignal(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 21, 1) != 0

    /** Get Code ACCompAuthorized **/
    fun get_ACCompAuthorized(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 22, 1) != 0

    /** Get Code ACHighPressureSensor **/
    fun get_ACHighPressureSensor(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 23, 9)

    /** Get Code FloatingInhibition **/
    fun get_FloatingInhibition(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 32, 2)

    /** Get Code DMSOrder **/
    fun get_DMSOrder(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 34, 2)

    /** Get Code RST_VehicleMode **/
    fun get_RST_VehicleMode(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 38, 2)

    fun set_RST_VehicleMode(params: Int) =
        this.setFrameParams(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 38, 2, params)

    /** Get Code AllowedPowerGradient **/
    fun get_AllowedPowerGradient(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 40, 8)

    /** Get Code AlternatorMaximumPower **/
    fun get_AlternatorMaximumPower(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 48, 8)

    /** Get Code ACCompMaximumPower **/
    fun get_ACCompMaximumPower(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_RNr_01.idcan, 56, 8)

    /** CoolingFanSpeedStatus **/

    fun get_CoolingFanSpeedStatus(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.ECM_CANHS_R_03.idcan, 48, 2)
    /**
     *  Lights, Ambient, Batt
     **/

    /** Get code EMM_Refuse_to_Sleep **/
    fun get_EMM_Refuse_to_Sleep(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 0, 2)


    /** Get Code PositionLightsOmissionWarningEMM **/
    fun get_PositionLightsOmissionWarningEMM(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 2, 2)

    /** Get code IgnitionControlState **/
    fun get_IgnitionControlState(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 4, 1) != 0

    /** Get IgnitionSupplyConfirmation  **/
    fun get_IgnitionSupplyConfirmation(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 5, 1) != 0

    /** Get IdleSpeedInhibitionRequest **/
    fun get_IdleSpeedInhibitionRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 6, 2)

    /** Get SharpInstantMecanicalPowerByAlt **/
    fun get_SharpInstantMecanicalPowerByAlt(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 8, 8)

    /** Get ElecPowerConsumedByAux **/
    fun get_ElecPowerConsumedByAux(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 16, 8)

    /** Get AlternatorLoad **/
    fun get_AlternatorLoad(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 24, 8)

    /** Get SOCBattery14V **/
    fun get_SOCBattery14V(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 32, 6)

    /** Get RearFogLightStateDisplayEMM **/
    fun get_RearFogLightStateDisplayEMM(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 38, 1) != 0

    /** Get FrontFogLightStateDisplayEMM **/
    fun get_FrontFogLightStateDisplayEMM(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 39, 1) != 0

    /** Get PositionLightsDisplayEMM **/
    fun get_PositionLightsDisplayEMM(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 40, 1) != 0

    /** Get HighBeamDisplayEMM **/
    fun get_HighBeamDisplayEMM(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 41, 1) != 0

    /** Get LowBeamDisplayEMM **/
    fun get_LowBeamDisplayEMM(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 42, 1) != 0

    /** Get RemoteLightingRequest **/
    fun get_RemoteLightingRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 43, 2)

    /** Get EngineStopAutoWarnStatus **/
    fun get_EngineStopAutoWarnStatus(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 45, 1) != 0

    /** Get MiniConsumptionRequest**/
    fun get_MiniConsumptionRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 48, 2)

    /** Get BatteryVoltage **/
    fun get_BatteryVoltage(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.EMM_CANHS_R_01.idcan, 56, 8)
    ...
    fun get_FrontLeftBrakeTemperature(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BRAKE_CANHS_Rst_01.idcan, 0, 8)

    /** Get Code FrontRightBrakeTemperature **/
    fun get_FrontRightBrakeTemperature(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BRAKE_CANHS_Rst_01.idcan, 8, 8)

    /** Get code RearLeftBrakeTemperature **/
    fun get_RearLeftBrakeTemperature(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BRAKE_CANHS_Rst_01.idcan, 16, 8)

    /** Get Code RearRightBrakeTemperature **/
    fun get_RearRightBrakeTemperature(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BRAKE_CANHS_Rst_01.idcan, 24, 8)


    /** Get code FrontLeftWheelTemperature **/
    fun get_FrontLeftWheelTemperature(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.TPMS_Rst1.idcan, 0, 8)

    /** Get Code FrontRightWheelTemperature **/
    fun get_FrontRightWheelTemperature(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.TPMS_Rst1.idcan, 8, 8)

    /** Get code RearLeftWheelTemperature **/
    fun get_RearLeftWheelTemperature(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.TPMS_Rst1.idcan, 16, 8)

    /** Get Code RearRightWheelTemperature **/
    fun get_RearRightWheelTemperature(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.TPMS_Rst1.idcan, 24, 8)

    /** Get Code LeftDrivenWheelSlip **/
    fun get_LeftDrivenWheelSlip(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BRAKE_CANHS_Rst_01.idcan, 32, 6)

    /** Get Code RightDrivenWheelSlip **/
    fun get_RightDrivenWheelSlip(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BRAKE_CANHS_Rst_01.idcan, 38, 2)
    ...
    fun get_SpeedPressureMisadaptation(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 0, 1) != 0


    /** Get Code TPMSFailureWarningRequest **/
    fun get_TPMSFailureWarningRequest(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 1, 1) != 0

    /** Get code RearRightWheelState **/
    fun get_RearRightWheelState(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 2, 3)

    /** Get code RearLeftWheelState **/
    fun get_RearLeftWheelState(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 5, 3)

    /** Get code FrontRightWheelState **/
    fun get_FrontRightWheelState(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 8, 3)

    /** Get code FrontLeftWheelState **/
    fun get_FrontLeftWheelState(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 11, 3)

    /** Get Right_LeftImbalance **/
    fun get_Right_LeftImbalance(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 14, 2)

    /** Get RearRightWheelPressure_V2 **/
    fun get_RearRightWheelPressure_V2(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 16, 8)

    /** Get RearLeftWheelPressure_V2 **/
    fun get_RearLeftWheelPressure_V2(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 24, 8)

    /** Get FrontRightWheelPressure_V2 **/
    fun get_FrontRightWheelPressure_V2(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 32, 8)

    /** Get FrontLeftWheelPressure_V2 **/
    fun get_FrontLeftWheelPressure_V2(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 40, 8)

    /** Get TPMS_AckResetDriver **/
    fun get_TPMS_AckResetDriver(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_TPMS_CANHS_R_01.idcan, 48, 2)

    /** Get Cluster_ResetRequest **/

    fun get_Cluster_ResetRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_05.idcan, 0, 1)

    /** Get TripUnitConsumption **/

    fun get_TripUnitConsumption(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_05.idcan, 1, 3)

    /** Get TripUnitDistance **/
    fun get_TripUnitDistance(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_05.idcan, 4, 2)

    /** Get TripAverageConsumption **/
    fun get_TripAverageConsumption(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_05.idcan, 6, 10)

    /** Get TripDistance **/
    fun get_TripDistance(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_05.idcan, 16, 17)

    /** Get TripConsumption **/

    fun get_TripConsumption(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_05.idcan, 33, 15)

    /** Get TripAverageSpeed **/

    fun get_TripAverageSpeed(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_05.idcan, 48, 12)

    /** Get AdvisorEcoLightingActivationStat **/

    fun get_AdvisorEcoLightingActivationStat(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_05.idcan, 60, 2)

    /** Get MilageMinBeforeOverhaul **/
    fun get_MilageMinBeforeOverhaul(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_07.idcan, 0, 8)

    /** Get  TimeBeforeOverhaul**/
    fun get_TimeBeforeOverhaul(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_07.idcan, 8, 9)

    /** Get  AlertMinBeforeOverhaul**/
    fun get_AlertMinBeforeOverhaul(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.CLUSTER_CANHS_R_07.idcan, 17, 2)

    /** Get    FlashingIndicatorStatusDisplay **/
    fun get_FlashingIndicatorStatusDisplay(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 0, 3)

    /** Get    RearFogLightStateDisplay **/
    fun get_RearFogLightStateDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 3, 1) != 0

    /** Get         FrontFogLightsDisplay **/
    fun get_FrontFogLightsDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 4, 1) != 0

    /** Get         PositionLightsDisplay **/
    fun get_PositionLightsDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 5, 1) != 0

    /** Get         LowBeamDisplay **/
    fun get_LowBeamDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 6, 1) != 0

    /** Get         HighBeamDisplay **/
    fun get_HighBeamDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 7, 1) != 0

    /** Get         PositionLightsOmissionWarning **/
    fun get_PositionLightsOmissionWarning(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 8, 2)

    /** Get         ALSMalfunction **/
    fun get_ALSMalfunctionl(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 10, 1) != 0

    /** Get        FrontLeftDoorOpenWarning **/
    fun get_FrontLeftDoorOpenWarning(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 11, 2)

    /** Get        FrontRightDoorOpenWarning **/
    fun get_FrontRightDoorOpenWarning(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 13, 2)

    /** Get         KeyInfoReemissionRequest **/
    fun get_KeyInfoReemissionRequestl(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 15, 1) != 0

    /** Get        RearLeftDoorOpenWarning **/
    fun get_RearLeftDoorOpenWarning(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 16, 2)

    /** Get         RearRightDoorOpenWarning **/
    fun get_RearRightDoorOpenWarning(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 18, 2)

    /** Get         BDUSafetyLineFailure **/
    fun get_BDUSafetyLineFailure(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 20, 1) != 0

    /** Get        SteeringLock_Failure **/
    fun get_SteeringLock_Failure(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 21, 2)

    /** Get         UnlockingSteeringColumnWarning **/
    fun get_UnlockingSteeringColumnWarning(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 23, 1) != 0

    /** Get         AutomaticLockUpActivationState **/
    fun get_AutomaticLockUpActivationState(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 24, 1) != 0

    /** Get         BadgeBatteryLow **/
    fun get_BadgeBatteryLow(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 25, 1) != 0

    /** Get        ChildproofLockMalfunctionDisplay **/
    fun get_ChildproofLockMalfunctionDisplay(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 26, 2)

    /** Get         TripDisplayScrollingRequest **/
    fun get_TripDisplayScrollingRequest(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 28, 2)

    /** Get         StartAutoInformationDisplay **/
    fun get_StartAutoInformationDisplay(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 30, 2)

    /** Get         SmartKeylessInformationDisplay **/
    fun get_SmartKeylessInformationDisplay(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 32, 4)

    /** Get         KeylessInfoReemissionRequest **/
    fun get_KeylessInfoReemissionRequest(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 34, 1) != 0

    /** Get         KeylessCardReaderFailureDisplay **/
    fun get_KeylessCardReaderFailureDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 35, 1) != 0

    /** Get         DRLstate **/
    fun get_DRLstate(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 36, 2)

    /** Get         FollowMeHomeDurationDisplay **/
    fun get_FollowMeHomeDurationDisplay(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 40, 3)

    /** Get         SingleDoorOpeningState **/
    fun get_SingleDoorOpeningState(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 43, 2)

    /** Get        ManualLockDisplayRequest **/
    fun get_ManualLockDisplayRequest(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 45, 1) != 0

    /** Get         ClutchSwitchFaultDisplay **/
    fun get_ClutchSwitchFaultDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 46, 1) != 0

    /** Get         BrakeSwitchFaultDisplay **/
    fun get_BrakeSwitchFaultDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 47, 1) != 0

    /** Get         StopLampFailureDisplay_BCM **/
    fun get_StopLampFailureDisplay_BCM(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 49, 1) != 0

    /** Get         FlashingIndicatorFailureDisplay **/
    fun get_FlashingIndicatorFailureDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 50, 1) != 0

    /** Get         VarPowSteeringFailureDisplay **/
    fun get_VarPowSteeringFailureDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 51, 1) != 0

    /** Get        AutomaticLockUpInhibitionWarning **/
    fun get_AutomaticLockUpInhibitionWarning(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 52, 1) != 0

    /** Get        KeyInformationDisplay **/
    fun get_KeyInformationDisplay(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 52, 3)

    /** Get         RearWiperStatus **/
    fun get_RearWiperStatus(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 56, 2)

    /** Get         BootOpenWarning **/
    fun get_BootOpenWarning(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BCM_CANHS_R_01.idcan, 58, 2)
    ...
    fun get_CurrentAudioSourceV2(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.Audio_Info.idcan, 0, 4)

    /** Get CurrentRadioBand **/
    fun get_CurrentRadioBand(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.Audio_Info.idcan, 4, 4)

    /** Get CurrentRadioMode **/
    fun get_CurrentRadioMode(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.Audio_Info.idcan, 8, 2)

    /** Get CurrentRadioPreset **/
    fun get_CurrentRadioPreset(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.Audio_Info.idcan, 10, 4)

    /** Get CurrentAudioStatus **/
    fun get_CurrentAudioStatus(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.Audio_Info.idcan, 16, 2)

    /** Get CurrentPhoneStatus **/
    fun get_CurrentPhoneStatus(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.Audio_Info.idcan, 18, 3)

    /** Get CurrentAudioTrackNumber **/
    fun get_CurrentAudioTrackNumber(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.Audio_Info.idcan, 24, 8)
    ...
    fun get_VehicleClock_Hour(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.CustomerClockSync.idcan, 3, 5)

    /** Sets VehcileClok_hour - Not Use **/
    fun set_VehicleClock_Hour(hour: Int) {
        this.setFrameParams(0,CanMCUAddrs.CustomerClockSync.idcan, 3, 5, hour)
    }

    /** Get VehicleClock_Minute **/
    fun get_VehicleClock_Minute(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.CustomerClockSync.idcan, 10, 6)

    /** Sets scroll value - Not Use **/
    fun set_VehicleClock_Minute(minute: Int) {
        this.setFrameParams(0,CanMCUAddrs.CustomerClockSync.idcan, 10, 6, minute)
    }

    /** Get VehicleClock_Second **/
    fun get_VehicleClock_Second(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.CustomerClockSync.idcan, 18, 6)

    /** Sets VehicleClock_Second **/

    fun set_VehicleClock_Second(seconde: Int) {
        this.setFrameParams(0,CanMCUAddrs.CustomerClockSync.idcan, 18, 6, seconde)
    }
    ...
    fun get_Ac_Oddo_MM(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data1.idcan, 0, 16)
    ...
    fun get_ClutchSwitchMaximumTravel_MM(): Boolean =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data1.idcan, 35, 2) != 0


    /** Get ClutchSwitchMinimumTravel **/
    fun get_ClutchSwitchMinimumTravel_MM(): Boolean =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data1.idcan, 37, 2) != 0


    /** Get FuelLow_MM **/
    fun get_FuelLow_MM(): Boolean =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data1.idcan, 39, 1) != 0


    /** Get DisplayedSpeedUnit_MM **/
    fun get_DisplayedSpeedUnit_MM(): Boolean =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data1.idcan, 40, 1) != 0


    /** Get BrakeInfoStatus_MM **/
    fun get_BrakeInfoStatus_MM(): Boolean =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data1.idcan, 41, 3) != 0


    /** Get VehicleState_MM **/
    fun get_VehicleState_MM(): Boolean =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data1.idcan, 44, 3) != 0


    /** Get TCU_MuteRadioOrder **/
    fun get_TCU_MuteRadioOrder(): Boolean =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data1.idcan, 47, 1) != 0
    ...
    fun get_LongitudinalAcceleration_MM(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data2.idcan, 0, 8)


    /** Get TransversalAcceleration **/
    fun get_TransversalAcceleration(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data2.idcan, 8, 16)


    /** Get SteeringWheelRotationSpeed **/
    fun get_SteeringWheelRotationSpeed(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data2.idcan, 24, 16)

    /** Get YawRate **/
    fun get_YawRate(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data2.idcan, 40, 12)


    /** Get LongitudinalAccelerationExtented **/
    fun get_LongitudinalAccelerationExtented(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Chassis_Data2.idcan, 41, 7)
    ...
    fun get_ATCoolingFanSpeedRequest():Int = this.getFrameParamsFromBus(1,CanECUAddrs.TORQUE_AT_CANHS_RNr_01.idcan, 44, 2)

    fun get_AnticipatedCurrentShift():Int = this.getFrameParamsFromBus(1,CanECUAddrs.TORQUE_AT_CANHS_RNr_01.idcan, 46, 2)
    ...
    fun get_StartAutoAuthorization(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.SSCU_CANHS_R_02.idcan, 2, 2)
    ...
    fun get_LightSensorStatus_MM(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Steering.idcan, 4, 2)

    /** Get SteeringWheelAngle_Offset **/
    fun get_SteeringWheelAngle_Offset(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Steering.idcan, 8, 16)

    /** Get SteeringWheelAngle **/
    fun get_SteeringWheelAngle(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Steering.idcan, 24, 16)

    /** Get SwaSensorInternalStatus **/
    fun get_SwaSensorInternalStatus(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_Steering.idcan, 44, 3)
    ...
    fun get_NextAction_Distance(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.RoadNavigation.idcan, 0, 12)

    fun set_NextAction_Distance(distance: Int) =
        this.setFrameParams(0,CanMCUAddrs.RoadNavigation.idcan, 0, 12, distance)

    fun get_NextAction_Unit(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.RoadNavigation.idcan, 12, 2)

    fun set_NextAction_Unit(unit: Int) =
        this.setFrameParams(0,CanMCUAddrs.RoadNavigation.idcan, 12, 2, unit)

    fun get_Action_A_Icon(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.RoadNavigation.idcan, 16, 2)

    fun set_Action_A_Icon(icon: Int) =
        this.setFrameParams(0,CanMCUAddrs.RoadNavigation.idcan, 16, 2, icon)

    fun get_Action_B_Icon(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.RoadNavigation.idcan, 24, 2)

    fun set_Action_B_Icon(icon: Int) =
        this.setFrameParams(0,CanMCUAddrs.RoadNavigation.idcan, 24, 2, icon)

    fun get_Action_C_Icon(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.RoadNavigation.idcan, 32, 2)

    fun set_Action_C_Icon(icon: Int) =
        this.setFrameParams(0,CanMCUAddrs.RoadNavigation.idcan, 32, 2, icon)

    fun get_Action_D_Icon(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.RoadNavigation.idcan, 40, 2)

    fun set_Action_D_Icon(icon: Int) =
        this.setFrameParams(0,CanMCUAddrs.RoadNavigation.idcan, 40, 2, icon)

    fun get_NextActionsIconOrder(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.RoadNavigation.idcan, 48, 2)

    fun set_NextActionsIconOrder(next: Int) =
        this.setFrameParams(0,CanMCUAddrs.RoadNavigation.idcan, 48, 2, next)
    ...
    fun get_DayNightStatus_MM(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.GW_MMI_Info1.idcan, 4, 2)

    fun get_DisplayActivation(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.GW_MMI_Info1.idcan, 6, 2)

    fun get_DimmingValue(): Int = this.getFrameParamsFromBus(0,CanMCUAddrs.GW_MMI_Info1.idcan, 8, 16)

    fun get_InternalLightingActivationState(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_MMI_Info1.idcan, 32, 1)

    fun get_SwitchOffSESDisturbers_MM(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_MMI_Info1.idcan, 33, 1)

    fun get_MMDisplayMode_Status_MM(): Int =
        this.getFrameParamsFromBus(0,CanMCUAddrs.GW_MMI_Info1.idcan, 34, 2)
    ...
    fun get_StopStartSwitch(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.BCM_CANHS_R_08.idcan, 26, 2)

    fun get_BatteryVoltage_V2(): Int = this.getFrameParamsFromBus(1,CanECUAddrs.BCM_CANHS_R_08.idcan, 8, 8)

    fun get_BCM_StopAutoForbidden(): Int =
        this.getFrameParamsFromBus(1,CanECUAddrs.BCM_CANHS_R_08.idcan, 16, 2)
    ...
    fun get_ESPDeactivatedByDriverForDisplay(): Boolean =
        this.getFrameParamsFromBus(1,CanECUAddrs.MMI_BRAKE_CANHS_RNr_01.idcan, 5, 1) != 0
