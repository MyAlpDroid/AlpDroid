...
enum class CanECUAddrs(val idcan: Int) {
	...
	CANECUREC_ECM(0x7E9),
	CANECUREC_SCR(0x7EE),
	CANECUSEND_ABS(0x740),
	CANECUSEND_EPS(0x742),
	CANECUSEND_ETT(0x743),
	CANECUSEND_CLIM(0x744),
	CANECUSEND_TPS(0x745),
	CANECUSEND_MMU(0x747),
	CANECUSEND_EMM(0x74D),
	CANECUSEND_AUP(0x74E),
	CANECUSEND_SRS(0x752),
	CANECUSEND_APB(0x755),
	CANECUREC_ABS(0x760),
	CANECUREC_EPS(0x762),
	CANECUREC_ETT(0x763),
